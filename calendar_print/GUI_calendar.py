...
root = Tk()
w = tk.Label(root, text = "Calendar")
w.pack()

Label(root, text='How many days are in this month?').grid(row=0)
Label(root, text='what day of the week did this month start on? ' \
'Enter 1 for Monday, 2 for Tuesday, 3 for Wednesday, 4 for Thursday, 5 for Friday, 6 for Saturday, 7 for Sunday,').grid(row=1)
e1 = Entry(root)
e2 = Entry(root)
